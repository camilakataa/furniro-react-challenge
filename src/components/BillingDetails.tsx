      ...
      <div className="flex flex-col justify-center mt-8 lg:w-[400px] xl:w-[533px]">
        ...
        <div className="flex justify-between items-center mb-3">
          <div className="flex gap-3">
            <p className="font-normal text-gray-400">Asgaard sofa</p>
            <p>x <span>1</span></p>
          </div>
          <p className="font-light">R$ 250.000</p>
        </div>
        <div className="flex justify-between items-center mb-3">
          <p className="font-normal text-sm">Subtotal</p>
          <p className="font-light text-sm">R$ 250.000</p>
        </div>
        <div className="flex justify-between items-center pb-6 border-solid border border-x-0 border-t-0 border-gray-200">
          ...
          <p className="font-bold text-[24px] text-yellow-dark">R$ 250.000</p>
        </div>
        <div className="pt-6 py-4">
          <input type="radio" name="transfer" id="transfer" />
          <label className="pl-4 text-gray-400 font-normal checked:text-black checked:font-bold" htmlFor="transfer">Direct Bank Transfer</label>
        </div>
        <div>
          <input className="checked:bg-black" type="radio" name="transfer" id="cash" />
          <label className="pl-4 text-gray-400 font-normal" htmlFor="cash">Cash On Delivery</label>
        </div>
        <p className="text-justify font-normal py-6">Your personal data will be used to support your experience throughout this website, to manage access to your account, and for other purposes described in our <span className="font-bold">privacy policy</span>.</p>
